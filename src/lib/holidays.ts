/** Japanese national holidays 2024-2027 (hardcoded) */
...
export function isHoliday(dateStr: string): boolean {
  return dateStr in JP_HOLIDAYS;
}

/** Check if a date is a rest day (Saturday, Sunday, or holiday) */
export function isRestDay(y: number, m: number, d: number): boolean {
